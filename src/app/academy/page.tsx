...
const MASTER_GUIDES = [
    {
        title: "How to Calculate Bolt Torque",
        icon: <Wrench size={24} />,
        desc: "Theory of preloads, K-factors, and real applications for critical fasteners.",
    ...
    {
        title: "Beam Deflection Formula",
        icon: <Layers size={24} />,
        desc: "Euler-Bernoulli derivations, inertia calculation, and real-world examples.",
    ...
    },
    {
        ...
        desc: "Darcy-Weisbach equation, Reynolds numbers, and pump sizing guide.",
        slug: "pressure-drop-calculation-guide",
        color: "cyan",
        count: "Fluid Dynamics"
    },
    {
        title: "Motor Power Calculation",
        icon: <Zap size={24} />,
        desc: "Torque, rotational speed, and transmission efficiency sizing.",
                ...
                <section className="mb-32">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {MASTER_GUIDES.map((cat, i) => (
                            <Link href={`/academy/${cat.slug}`} key={i}>
                                <motion.div 
                                    whileHover={{ y: -5 }}
