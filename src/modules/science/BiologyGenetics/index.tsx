...
export default function BiologyGenetics() {
    return (
        <div className="flex flex-col items-center justify-center w-full h-full bg-[#050505] text-white overflow-hidden relative">
            ...
            >
                <div className="w-20 h-20 bg-purple-500/20 text-purple-400 rounded-2xl flex items-center justify-center mb-6 border border-purple-500/50 shadow-[0_0_30px_rgba(168,85,247,0.5)]">
                    <Dna size={40} />
                </div>
                <h1 className="text-3xl font-black tracking-tighter mb-4 uppercase italic">Bio-Genetics</h1>
                <p className="text-gray-400 text-sm leading-relaxed mb-8">
                    DNA sequence analyzer and protein folding simulator warming up. Mapping bioinformatics library.
                </p>
