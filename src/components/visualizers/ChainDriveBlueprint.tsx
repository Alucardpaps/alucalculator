    ...
    return (
        <svg viewBox={`0 0 ${W} ${H}`} className="w-full h-full" preserveAspectRatio="xMidYMid meet">
            ...
            <g style={{
                ...
                {/* Spokes */}
                <line x1={layout.cx1 - layout.srPitch1 * 0.6} y1={layout.cy} x2={layout.cx1 + layout.srPitch1 * 0.6} y2={layout.cy} stroke="#00e5ff" strokeWidth="0.8" opacity="0.3" />
                <line x1={layout.cx1} y1={layout.cy - layout.srPitch1 * 0.6} x2={layout.cx1} y2={layout.cy + layout.srPitch1 * 0.6} stroke="#00e5ff" strokeWidth="0.8" opacity="0.3" />
            </g>
            ...
            <g style={{
                ...
                {/* Spokes */}
                <line x1={layout.cx2 - layout.srPitch2 * 0.6} y1={layout.cy} x2={layout.cx2 + layout.srPitch2 * 0.6} y2={layout.cy} stroke="#8b5cf6" strokeWidth="0.8" opacity="0.3" />
                <line x1={layout.cx2} y1={layout.cy - layout.srPitch2 * 0.6} x2={layout.cx2} y2={layout.cy + layout.srPitch2 * 0.6} stroke="#8b5cf6" strokeWidth="0.8" opacity="0.3" />
            </g>
            ...
            {chainRun && (
                <>
                    ...
                    <path
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        style={{ animation: 'chainRun 1.8s linear infinite' }}
                    />
                </>
            )}
