...
const FOOTER_LINKS: FooterColumn[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/transformer-calculation', label: 'Transformer Design' },
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/fatigue-analysis', label: 'Fatigue Life (Goodman)' },
      { href: '/column-buckling', label: 'Column Buckling' },
  ...
  },
  {
    title: 'Apps & Platform',
    links: [
      { href: '/download', label: 'Mobile & Watch Apps' },
      { href: '/app/alucalc-release.apk', label: 'Android APK (Direct)' },
      { href: '/app/alucalc-wear-release.apk', label: 'Wear OS APK (Direct)' },
      { href: '/field', label: 'Field Tools Suite' },
      { href: '/privacy', label: 'Privacy & KVKK' },
...
const KO: HomeFooterStrings = {
    ...
    footerColumns: [{"title":"기계","links":[{"href":"/bolt-torque","label":"볼트 토크 계산기"},{"href":"/bearings","label":"볪ring 수명 (ISO 281)"},{"href":"/gears","label":"기어 비 계산기"},{"href":"/shafts","label":"샤프트 직경"},{"href":"/hooke-law","label":"스프링 상수"},{"href":"/motor-selection-std","label":"모터 출력"}]},{"title":"구조","links":[{"href":"/beam-deflection","label":"보 척오"},{"href":"/concrete-reinforcement","label":"간짜 배근"},{"href":"/fea","label":"FEA 분석"},{"href":"/topology-optimization","label":"토폴로지 최적화"},{"href":"/workspace","label":"기계 조립"}]},{"title":"유체 및 열","links":[{"href":"/fluid-dynamics","label":"압력 감소"},{"href":"/thermal-expansion","label":"열전달"},{"href":"/pumps","label":"펌프 성능"},{"href":"/reducer-lubrication","label":"감속기 각진"},{"href":"/naval-hydrostatics","label":"선박 정수력학"}]},{"title":"전기","links":[{"href":"/three-phase-power","label":"전력 계산기"},{"href":"/ohms-law","label":"오즘의 법칙"},{"href":"/voltage-drop","label":"전압 감소"},{"href":"/transformer-calculation","label":"3상 전력"},{"href":"/filter-design","label":"필터 설계"}]},{"title":"과학","links":[{"href":"/physics-solver","label":"물리 CAS 솔버"},{"href":"/failure-prediction","label":"고장 예측"},{"href":"/failure-diagnosis","label":"고장 진단"},{"href":"/biology-genetics","label":"군집 유전학"},{"href":"/digital-logic","label":"디지털 로직 랩"}]},{"title":"플랫폼","links":[{"href":"/academy?tab=calculators","label":"모든 계산기"},{"href":"/workspace","label":"Workspace 열기"},{"href":"/academy","label":"공학 아카데미"},{"href":"/","label":"홈"}]}],
    copyright: "© 2026 AluCalc Advanced Engineering Systems",
};
...
const AR: HomeFooterStrings = {
    ...
    footerColumns: [{"title":"ميكانيكا","links":[{"href":"/bolt-torque","label":"حاسبة عزم البراغي"},{"href":"/bearings","label":"عمر المحمل (ISO 281)"},{"href":"/gears","label":"حاسبة نسبة الترس"},{"href":"/shafts","label":"قطر العمود"},{"href":"/hooke-law","label":"ثابت الزنبر"},{"href":"/motor-selection-std","label":"قدرة المحرك"}]},{"title":"إنشائي","links":[{"href":"/beam-deflection","label":"انحناء العارضة"},{"href":"/concrete-reinforcement","label":"تسليح الخرسانة"},{"href":"/fea","label":"تحليل FEA"},{"href":"/topology-optimization","label":"تحسين التوپولوجيا"},{"href":"/workspace","label":"تركيب الآلات"}]},{"title":"السوائل والحرارية","links":[{"href":"/fluid-dynamics","label":"انخفاض الضغط"},{"href":"/thermal-expansion","label":"نقل الحرارة"},{"href":"/pumps","label":"أداء المضخة"},{"href":"/reducer-lubrication","label":"تزييت صندوق الترس"},{"href":"/naval-hydrostatics","label":"الهيدروستاتيكا البحرية"}]},{"title":"كهربائي","links":[{"href":"/three-phase-power","label":"حاسبة القدرة"},{"href":"/ohms-law","label":"قانون أوم"},{"href":"/voltage-drop","label":"انخفاض الجهد"},{"href":"/transformer-calculation","label":"القدرة ثلاثية الأطوال"},{"href":"/filter-design","label":"تصميم المرشحات"}]},{"title":"علوم","links":[{"href":"/physics-solver","label":"حالل فيزياء CAS"},{"href":"/failure-prediction","label":"توقع العطل"},{"href":"/failure-diagnosis","label":"تشخيص العطل"},{"href":"/biology-genetics","label":"علم الجينيات السكاني"},{"href":"/digital-logic","label":"مختبر المنطق الرقمي"}]},{"title":"المنصة","links":[{"href":"/academy?tab=calculators","label":"جميع الحاسبات"},{"href":"/workspace","label":"فتح مساح العمل"},{"href":"/academy","label":"أكاديمية الهندسة"},{"href":"/","label":"الرئيسية"}]}],
    copyright: "© 2026 AluCalc Advanced Engineering Systems",
};
