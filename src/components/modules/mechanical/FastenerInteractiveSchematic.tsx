        ...
        <div className="relative w-full h-full flex flex-col bg-[#04060a] border border-white/5 rounded-2xl overflow-hidden min-h-[220px]">
            ...
            <div className="flex-1 relative min-h-0">
                <svg viewBox="0 0 490 200" className="w-full h-full" preserveAspectRatio="xMidYMid meet">
                    ...
                    {/* Animated Tension Arrows (Left / Right Clamping Preload) */}
                    <g opacity="0.85">
                        {/* Left Arrow at Bolt Head */}
                        <path d={`M ${g.x0 - 10} ${g.cy} L ${g.x0 - 2} ${g.cy} M ${g.x0 - 6} ${g.cy - 3} L ${g.x0 - 2} ${g.cy} L ${g.x0 - 6} ${g.cy + 3}`} stroke="#00e5ff" strokeWidth="1.8" strokeLinecap="round" />
                        {/* Right Arrow at Nut */}
                        <path d={`M ${g.xNutRight + 10} ${g.cy} L ${g.xNutRight + 2} ${g.cy} M ${g.xNutRight + 6} ${g.cy - 3} L ${g.xNutRight + 2} ${g.cy} L ${g.xNutRight + 6} ${g.cy + 3}`} stroke="#00e5ff" strokeWidth="1.8" strokeLinecap="round" />
                    </g>
