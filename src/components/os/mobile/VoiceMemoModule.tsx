...
import { formatFieldToolsTemplate, getFieldToolsStrings } from '@/locales/fieldToolsTranslations';
...
export function VoiceMemoModule({ ft: propFt }: { ft?: FieldToolsStrings }) {
