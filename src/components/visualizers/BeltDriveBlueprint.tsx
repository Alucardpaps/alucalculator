...
function PulleyGraphic({
    cx, cy, rPitch, rBody, z, stroke, isTiming, isV, grooveScale, ids, rpm = 1450, isDriven = false, ratio = 1,
}: {
    ...
    if (isTiming && z != null && z >= 6) {
        return (
            <g style={animStyle}>
                ...
                <line x1={cx - rBody * 0.7} y1={cy} x2={cx + rBody * 0.7} y2={cy} stroke={stroke} strokeWidth="0.8" opacity="0.4" />
                <line x1={cx} y1={cy - rBody * 0.7} x2={cx} y2={cy + rBody * 0.7} stroke={stroke} strokeWidth="0.8" opacity="0.4" />
            </g>
        );
    }
    return (
        <g style={animStyle}>
            ...
            {/* Rotating Cross Spokes */}
            <line x1={cx - rPitch * 0.7} y1={cy} x2={cx + rPitch * 0.7} y2={cy} stroke={stroke} strokeWidth="0.8" opacity="0.4" />
            <line x1={cx} y1={cy - rPitch * 0.7} x2={cx} y2={cy + rPitch * 0.7} stroke={stroke} strokeWidth="0.8" opacity="0.4" />
        </g>
    );
}
