...
# Read the file
with open(r'src\components\modules\fea\BeamCanvas3D.tsx', 'r', encoding='utf-8') as f:
    content = f.read()

# 1. Add imports
import_target = "import { SIGMA_PROFILES } from '../../../data/mechanical/profiles';"
import_replacement = """import { SIGMA_PROFILES } from '../../../data/mechanical/profiles';
...
parts = content.split('// --- MAIN CANVAS COMPONENT ---')
header_content = parts[0]

new_components = """// --- MAIN CANVAS COMPONENT ---
const BeamCanvas3D = () => {
    // Engine Instance
...
final_content = header_content + new_components

with open(r'src\components\modules\fea\BeamCanvas3D.tsx', 'w', encoding='utf-8') as f:
